#ifndef ACTIONPOLEIN_H
#define ACTIONPOLEIN_H
...
typedef struct
{
    emTaskDPoleInType m_eTaskType;
    uint8_t m_uTaskId;
}ST_POLEIN_SETTASK_INFO;

class ActionPoleIn :  public QObject, public HardCmdParser
{
    Q_OBJECT
public:
    explicit ActionPoleIn(QObject *parent = 0);
    ~ActionPoleIn(){};
...
private:
    ...
    //下层获取信息
    ST_POLEIN_SETTASK_INFO m_stTaskD;//任务信息
