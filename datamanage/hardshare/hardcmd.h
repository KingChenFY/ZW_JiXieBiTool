...
#define WK_BOARD_COMMAND_HEAD_LENGTH        (2)
#define WK_BOARD_CMD_HEAD_LENGTH            (12)
#define WK_BOARD_CMD_END_LENGTH             (4)
#define WK_NET_ONE_MESSAGE_MAX_LEN          (1024)
#define WK_NET_ONE_MESSAGE_MIN_LEN          (16)
#define WK_BOARD_CMD_CONTENT_MAX_LENGTH     (WK_NET_ONE_MESSAGE_MAX_LEN - WK_BOARD_CMD_HEAD_LENGTH - WK_BOARD_CMD_END_LENGTH)
...
typedef enum
{
    EnumBoardObject_BeltIn              = 0,
    EnumBoardObject_BeltOut             = 1,
    EnumBoardObject_PoleIn              = 2,
    EnumBoardObject_PoleOut             = 3,
...
typedef struct
{
    ...
    emBoardCmdId setCmd;
    emBoardCmdId getCmd;
}STRUCT_WK_TASKCMD_LIST;

extern STRUCT_WK_TASKCMD_LIST st_wk_taskcmd_list[EnumBoardObject_End];
